...
export function ReasoningBasic() {
  const reasoningText = `Based on your CRM data and recent allocations, I found 8 high-priority LPs:

1. **APG Asset Management** - Allocated €300M to European logistics last quarter
2. **GIC Singapore** - You met Emily Lin 6 months ago, showed interest in similar strategies
3. **CPPIB** - Active in European real assets, no contact in 4 months

[View full list with personalized outreach templates]`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              Which LPs should we approach for our €500M European logistics fund?
            </p>
          </motion.div>

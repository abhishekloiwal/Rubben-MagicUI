...
const boxConfigs: BoxConfig[] = [
  {
    title: "LP Meeting - Brookfield",
    className: "bg-secondary text-white",
  },
  {
    title: "Pitch to CalPERS",
    className: "bg-secondary/40 text-white",
  },
  {
    title: "Follow-up: GIC Singapore",
    className:
...
export function FourthBentoAnimation({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-10 w-[2px] h-[calc(100%-80px)] bg-gradient-to-b from-black dark:from-accent to-transparent z-10 left-1/2 -translate-x-1/2"
        initial={{ opacity: 0 }}
        animate={{
          opacity: 1,
        }}
      ...
      />
      <motion.div
        className="absolute top-14 bg-black dark:bg-accent h-6 z-20 flex items-center justify-center text-xs p-2 rounded-md shadow-[0px_2.2px_6.6px_0px_rgba(18,43,105,0.04),0px_1.1px_2.2px_0px_rgba(18,43,105,0.08),0px_0px_0px_1.1px_rgba(18,43,105,0.08),0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset] left-1/2 -translate-x-1/2"
        initial={{ opacity: 0 }}
        animate={{
          opacity: 1,
        }}
      ...
      <div
        className="w-full absolute grid gap-4 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 px-8"
        ref={containerRef}
      >
        <AnimatePresence>
